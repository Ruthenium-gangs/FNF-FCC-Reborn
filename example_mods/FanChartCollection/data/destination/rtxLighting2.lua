...
function onCreatePost()
    initLuaShader('RTXLighting2')
    setSpriteShader('boyfriend', 'RTXLighting2')
    setSpriteShader('dad', 'RTXLighting2')
    setSpriteShader('gf', 'RTXLighting2')
    ...
    for i = 0,eventsLength-1 do 
        ...
        if eventName == 'Open RTX Editor2' then
            useEditor = true
        elseif eventName == "Set RTX Data2" then
